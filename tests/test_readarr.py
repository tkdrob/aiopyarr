...
async def test_async_get_calendar(aresponses):
    ...
    assert _book.bookFiles.value[0].quality.quality.name == 0
    ...
    assert _book.bookFiles.value[0].author.value.metadata.value.status == "continued"
    ...
    assert _book.bookFiles.value[0].author.value.metadataProfile.isLoaded is True #605
